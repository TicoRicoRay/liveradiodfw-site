...
5. **B6 - Videos two-click bug.** See [bugs.md#b6](bugs.md). Investigation-heavy; not a quick fix.
6. **B14 - Show-detail buttons reorder + Share as primary CTA.** See [bugs.md#b14](bugs.md). Template + one CSS block, low risk, logged 2026-04-18 AM.
