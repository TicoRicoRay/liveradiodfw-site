...
_Last updated: 2026-04-19 · 10:54 AM Central_
...
8. **R18 - Locale SEO landing pages.** See [roadmap.md#r18](roadmap.md). "Band-type in {city}" intent capture, leveraging R16 historic calendar as proof-of-presence. Medium-high leverage; queue behind foundation work and R4.
9. **R21 - Verify /home 301 consolidation.** See [roadmap.md#r21](roadmap.md). Fact-finding only, earliest check 2026-05-03. Natural pair with R4 reassessment on the same date.
